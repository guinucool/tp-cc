    ...
    public static void main(String[] args) {
        ...
        try {
            if (args.length == 3) {
                ...
                System.out.println("FS Track protocol connection established with server " + args[1] + " port " + args[2] + ".");
            }

            else if (args.length == 2) {
                Client.startClient(args[0], args[1]);
                System.out.println("FS Track protocol connection established with server " + args[1] + " port 9090.");
            }
